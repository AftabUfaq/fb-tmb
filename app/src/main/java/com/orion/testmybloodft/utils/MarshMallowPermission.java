...
/**
 * Created by Arun on 20/4/16.
 */

/**
 * Method for  check self permission
 */
...
public class MarshMallowPermission {
    ...
    public void requestPermissionForContacts() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_CONTACTS)) {
            Toast.makeText(activity, "Read contacts permission needed for showing contacts. Please allow in App Settings for additional functionality.", Toast.LENGTH_LONG).show();
        } else {
